...
- [ ] 'clm texte' affiche ligne par ligne chaque mot du texte suivi de son nombre d'occurence.
- [ ] 'clm texte -a' tri les mots affichés dans l'ordre lexicographique.
- [ ] 'clm texte -n' tri les mots affichés en fonction de leur nombre d'occurence.
- [ ] 'clm TEXTE -s MOT' affiche chaque mot x suivi de MOT dans TEXTE, suivi du nombre d'occurence de x situé après MOT.
- [ ] 'clm TEXTE -p MOT' affiche chaque mot x qui précède MOT dans TEXTE, suivi du nombre d'occurence de x précédant MOT.
